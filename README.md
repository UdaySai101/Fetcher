...
# Installation:
- Even though cloning is a thing, recommend downloading the Java runnable <a href="https://www.github.com/UdaySai101/Fetcher/raw/master/Fetcher.jar">jar</a> for a seamless installation.
...
- Move the driver into the previously created folder (or to the folder where the jar rests).
...
- You can do that by typing in "cd [folder_path]"
